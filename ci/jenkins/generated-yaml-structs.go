...
type GithubCredStruct struct {
	Password string `json:"github-cred-password"` // github user password. Recommended. Stored as github-user credential in jenkins.
	Username string `json:"github-cred-username"` // github user name. Recommended. Stored as github-user credential in jenkins.
}
...
type AppMaintainStruct struct {
	AdminPwd string `json:"admin-pwd"` // To replace the default simple security admin password
	RegistryAuth string `json:"registry-auth"` // List of Docker registry servers authentication separated by coma. One registry server auth string is build as <server>:<token>[:<email>]
	GithubCredPassword string `json:"github-cred-password"` // github user password. Recommended. Stored as github-user credential in jenkins.
